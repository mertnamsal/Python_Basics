...
# Builder Design pattern kullanarak kredi kartı yaratacağız
...
class AmericanExpressCard(CreditCardBuilder):
    def __init__(self):
        super().__init__()
        self._credit_card = super().credit_card  # atadaki credit_card() call ettik
    ...
    def card_limit_func(self) -> int:
        self._credit_card.card_limit = 10000
...
class Creator:
    ...
    def create_credit_card(credit_card_builder: CreditCardBuilder):
        ...
        print(f'Shoppning Type: {credit_card_builder.installment_shopping_func()}')
...
# OCP, LSP, DI, IoC presnplerini araştırın
# MongoDB